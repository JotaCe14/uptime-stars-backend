...
internal sealed class DisableMonitorCommandHandler(IMonitorRepository monitorRepository, IUnitOfWork unitOfWork) : ICommandHandler<DisableMonitorCommand, Result>
{
